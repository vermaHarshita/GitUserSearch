...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<gusrs-big-input-action></gusrs-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<gusrs-big-input-action [disabled]="true"></gusrs-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<gusrs-big-input-action fontSet="fas" fontIcon="fa-trash"></gusrs-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<gusrs-big-input-action label="delete"></gusrs-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<gusrs-big-input-action (action)="actionHandler()"></gusrs-big-input-action>`;
    fixture = createHostComponent(template);
